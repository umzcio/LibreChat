...
class AgentClient extends BaseClient {
  ...
  async buildMessages(messages, parentMessageId, _buildOptions, opts) {
    ...
    const memoryContext = memoryResults
      ...
      : undefined;
    /** Mem0 has no keyed/unkeyed split (that's upstream's native-memory concept),
     *  so keyed agents get the same Mem0 context as everyone else. */
    const keyedMemoryContext = memoryContext;
    if (memoryContext) {
